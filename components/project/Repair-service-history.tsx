        ...
        <div className="p-8 bg-[#F9FAFB] min-h-screen font-sans text-gray-800">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 text-center italic">ประวัติการฝากซ่อมสินค้า</h1>
                        <p className="text-sm text-gray-500">ข้อมูลรายการฝากซ่อมทั้งหมดในระบบ</p>
                    </div>
                </div>
                ...
                <div className="flex justify-between items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                    <Input
                        ...
                        placeholder="ค้นหาชื่อสินค้า หรือชื่อผู้ฝาก..."
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <Table
                        aria-label="Repair service history table"
                        removeWrapper
                    ...
                    >
                        <TableHeader>
                            ...
                            <TableColumn className="bg-gray-50/50 text-gray-500 font-semibold">ชื่อผู้ฝากซ่อม</TableColumn>
                            <TableColumn className="bg-gray-50/50 text-gray-500 font-semibold text-center">วันที่รับซ่อม</TableColumn>
                            ...
                            <TableColumn className="bg-gray-50/50 text-gray-500 font-semibold text-right">ราคา</TableColumn>
                        </TableHeader>
                        <TableBody
                            items={filteredItems}
                            emptyContent={loading ? " " : "ไม่พบข้อมูลรายการฝากซ่อม"}
                            isLoading={loading}
