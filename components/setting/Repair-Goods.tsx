...
export default function RepairGoods() {
    const categoriesData = [
        { id: 1, name: "รอดำเนินการ", count: 3 },
        { id: 2, name: "กำลังซ่อม", count: 2 },
        { id: 3, name: "ซ่อมเสร็จสิ้น", count: 4 },
    ];

    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h2 className="text-2xl font-bold text-gray-900">สถานะการฝากซ่อม</h2>
            </div>
            ...
            <Table aria-label="Repair categories table" removeWrapper className="mt-4">
                <TableHeader>
