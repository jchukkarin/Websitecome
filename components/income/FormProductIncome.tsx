        ...
        <div className="p-8 bg-[#F9FAFB] min-h-screen font-sans text-gray-800">
            <div className="max-w-6xl mx-auto space-y-8">
                    ...
                    >
                        <CardBody className="p-6 space-y-4">
                            <div className="flex flex-col items-center justify-center py-10 space-y-4">
                                ...
                                />
                                <div
                                    className="w-16 h-16 rounded-full bg-purple-50 flex items-center justify-center cursor-pointer hover:bg-purple-100 transition-colors"
                                    onClick={() => fileInputRef.current?.click()}
                                >
                                    <PlusCircle className="text-purple-500" size={32} />
                                </div>
                ...
                <div className="space-y-4">
                    <h2 className="text-xl font-bold text-gray-900">รายการสินค้าฝากขาย</h2>
                    <Table
                    ...
                    >
                        <TableHeader>
                            ...
                            <TableColumn className="bg-gray-50/50 text-gray-500 font-semibold text-right">ราคาคอนเฟิร์ม</TableColumn>
                        ...
                        <TableBody items={items}>
                            {(item) => (
                                <TableRow key={item.id}>
                                    <TableCell>
                                        <div
                                            className="flex items-center justify-center border-2 border-dashed border-gray-200 rounded-lg w-16 h-12 bg-purple-50/30 cursor-pointer hover:border-purple-400 transition group relative overflow-hidden"
                                            onClick={() => document.getElementById(`consignment-file-item-${item.id}`)?.click()}
                                        >
                                            {item.imageUrl && (item.imageUrl.startsWith("data:") || item.imageUrl.startsWith("/")) ? (
                                                <img src={item.imageUrl} className="w-full h-full object-cover" />
                                            ) : (
                                                <Plus className="text-purple-400 group-hover:text-purple-600" size={16} />
                                            )}
                                            <input
                                                type="file"
                                                id={`consignment-file-item-${item.id}`}
                                                className="hidden"
                                    ...
                                    <TableCell align="right">
                                        <Input
                                            ...
                                            classNames={{ input: "text-right font-bold text-purple-600" }}
                                        />
                                    </TableCell>
