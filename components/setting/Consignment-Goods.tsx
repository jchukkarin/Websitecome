...
export default function ConsignmentGoods() {
    const categoriesData = [
        { id: 1, name: "กำลังวางขาย", count: 8 },
        { id: 2, name: "ขายแล้ว", count: 12 },
    ];

    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h2 className="text-2xl font-bold text-gray-900">สถานะการฝากขาย</h2>
            </div>
            ...
            <Table aria-label="Consignment categories table" removeWrapper className="mt-4">
                <TableHeader>
